  ...
  return (
    <footer className="mt-12 border-t border-gray-200 bg-white animate-fade-up">
      <div className="mx-auto grid max-w-7xl gap-8 px-4 py-8 sm:px-6 md:grid-cols-[1.2fr_0.8fr_0.8fr]">
        <div>
          <div className="flex items-center gap-3">
            <img src={nearbuyLogo} alt="NearBuy" className="h-14 w-14 rounded-2xl object-cover shadow-sm" />
            <div>
              <p className="text-xs font-semibold uppercase tracking-[0.25em] text-orange-600">NearBuy</p>
              <h2 className="mt-1 text-lg font-bold text-gray-900">Keep local buying and selling simple.</h2>
            </div>
          </div>
      ...
      <div className="border-t border-gray-100 px-4 py-4 text-center text-sm text-gray-500 sm:px-6">
        &copy; {new Date().getFullYear()} NearBuy
      </div>
    </footer>
  );
}
